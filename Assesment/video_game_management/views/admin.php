...
<title>Admin Dashboard &mdash; Video game  Management</title>
...
<main class="main-content">
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Register, edit, search and remove vendor accounts</p>
        </div>
    </div>

    <?php if (isset($_GET['msg'])): ?>
        <?php $messages = ['added' => 'Vendor added successfully.',
    ...
    <div class="card form-card">
        <h3 class="card-title">
            <?= $isEdit ? '&#9998; Edit Vendor (#' . intval($editing['id']) . ')' : '+ Add New Vendor' ?>
        </h3>
        <form method="POST"
    ...
    <div class="card">
        <div class="card-toolbar">
            ...
            <span class="badge" id="resultCount"><?= count($Vendors) ?> total</span>
        </div>
