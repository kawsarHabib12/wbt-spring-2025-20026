...
<title>Login &mdash; Video game Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <p>Manage all new games in one place. Sign in to access your dashboard.</p>
        <ul class="feature-list">
            <li>&#10003; Admin manages vendor</li>
            <li>&#10003; Vendor manage games</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="auth-foot">Don't have an account?
                <a href="index.php?page=register">Register as Vendor</a>
            </p>
