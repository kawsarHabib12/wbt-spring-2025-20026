...
<title>Vendor Dashboard &mdash; Video game  Management</title>
...
<main class="main-content">
    ...
    <?php if (isset($_GET['msg'])): ?>
        <?php $messages = ['added' => ' This game added successfully.',
                           'updated' => ' This game updated successfully.',
                           'deleted' => ' This game deleted successfully.'];
    ...
    <div class="card form-card">
        <h3 class="card-title">
            <?= $isEdit ? '&#9998; Edit game (#' . intval($editing['id']) . ')' : '+ Add New  games' ?>
        </h3>
        <form method="POST"
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a class="btn-sm btn-edit"
                                       href="index.php?page=librarian&action=edit&id=<?= $game['id'] ?>">Edit</a>
                                    <a class="btn-sm btn-delete"
                                       href="index.php?page=librarian&action=delete&id=<?= $game['id'] ?>"
...
<footer class="footer">&copy; <?= date('Y') ?> Video game  Management System</footer>
